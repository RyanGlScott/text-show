...
genericTextShowSpec :: forall a. (Arbitrary a, Show a, TextShow a,
                                  Generic a, GTextShow Builder (Rep a ()))
                    => Proxy a -> Spec
...
-- by the equivalent 'Generic' functions.
prop_genericTextShow :: (TextShow a, Generic a, GTextShow Builder (Rep a ()))
                     => Int -> a -> Expectation
...
genericTextShow1Spec :: forall f a. (Arbitrary (f a), Show (f a), TextShow1 f,
                                     Generic1 f, GTextShow1 Builder (Rep1 f), TextShow a)
                     => Proxy (f a) -> Spec
...
prop_genericTextShow1 :: ( TextShow1 f, Generic1 f
                         , GTextShow1 Builder (Rep1 f), TextShow a
                         )
                      => Int -> f a -> Expectation
