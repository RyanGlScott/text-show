...
* A serious bug in the `text` package that caused segfaults when building large `Integer`s (https://github.com/bos/text/issues/99) was fixed in `text-1.2.0.2`. A flag (`-frecent-text`) was added that allows you to take advantage of this.
